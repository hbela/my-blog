...
const postPath = join(__dirname, '..', 'docs', 'blog', 'a-backup-nobody-has-restored-is-a-hypothesis.md')
const content = readFileSync(postPath, 'utf8')

const slug = 'a-backup-nobody-has-restored-is-a-hypothesis'
...
const data = {
  title: 'A backup nobody has restored is a hypothesis',
  excerpt:
    'A few weeks after writing that a backup nobody has restored is a hypothesis, I stopped hedging: independently stored encryption keys, images rebuilt from source, a database and Redis restored on a Hetzner VPS that had never heard of this app, and a real HTTPS login in an actual browser — two hours and ten minutes from provisioning to a working session.',
  content,
  ...
  //   magick public/blog/a-backup-nobody-has-restored-is-a-hypothesis.svg public/blog/a-backup-nobody-has-restored-is-a-hypothesis.png
  image: '/blog/a-backup-nobody-has-restored-is-a-hypothesis.png',
  published,
}
